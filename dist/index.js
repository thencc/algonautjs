    ...
    */
    ...
    async atomicDeleteAsset(assetId) {
        if (!this.account)
            throw new Error('there was no account!');
        const enc = new TextEncoder();
        const transaction = algosdk.makeAssetDestroyTxnWithSuggestedParams(this.account.addr, enc.encode('doh!'), assetId, await this.algodClient.getTransactionParams().do());
        return {
    ...
    async atomicCreateApp(args) {
        ...
        if (args.optionalFields && args.optionalFields.note && args.optionalFields.note.length > 1023) {
            ...
            try {
                ...
                const applicationCreateTransaction = algosdk.makeApplicationCreateTxn(sender, params, onComplete, approvalProgram, clearProgram, args.schema.localInts, args.schema.localBytes, args.schema.globalInts, args.schema.globalBytes, this.encodeArguments(args.appArgs), ((_a = args.optionalFields) === null || _a === void 0 ? void 0 : _a.accounts) ? args.optionalFields.accounts : undefined, ((_b = args.optionalFields) === null || _b === void 0 ? void 0 : _b.applications) ? args.optionalFields.applications : undefined, ((_c = args.optionalFields) === null || _c === void 0 ? void 0 : _c.assets) ? args.optionalFields.assets : undefined, ((_d = args.optionalFields) === null || _d === void 0 ? void 0 : _d.note) ? new Uint8Array(Buffer.from(args.optionalFields.note, 'utf8')) : undefined);
                return {
    ...
    async deployTealWithLSig(args) {
        ...
        try {
            ...
            // create unsigned transaction
            if (approvalProgram && clearProgram) {
                const txn = algosdk.makeApplicationCreateTxn(sender, params, onComplete, approvalProgram, clearProgram, args.schema.localInts, args.schema.localBytes, args.schema.globalInts, args.schema.globalBytes, encodedArgs, ((_a = args.optionalFields) === null || _a === void 0 ? void 0 : _a.accounts) || undefined);
                const txId = txn.txID().toString();
    ...
    async atomicUpdateApp(args) {
        ...
        try {
            ...
            const applicationCreateTransaction = algosdk.makeApplicationUpdateTxn(sender, params, args.appIndex, approvalProgram, clearProgram, this.encodeArguments(args.appArgs), ((_a = args.optionalFields) === null || _a === void 0 ? void 0 : _a.accounts) ? args.optionalFields.accounts : undefined, ((_b = args.optionalFields) === null || _b === void 0 ? void 0 : _b.applications) ? args.optionalFields.applications : undefined, ((_c = args.optionalFields) === null || _c === void 0 ? void 0 : _c.assets) ? args.optionalFields.assets : undefined, ((_d = args.optionalFields) === null || _d === void 0 ? void 0 : _d.note) ? new Uint8Array(Buffer.from(args.optionalFields.note, 'utf8')) : undefined);
            return {
                transaction: applicationCreateTransaction,
                transactionSigner: this.account,
                isLogigSig: false
